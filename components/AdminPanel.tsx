                ...
                <div className="bg-white rounded-[32px] w-full max-w-lg shadow-2xl p-8 animate-in zoom-in">
                   ...
                   <form onSubmit={handleAddRewardSubmit} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div onClick={() => rewardImgRef.current?.click()} className="w-full aspect-video bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:bg-slate-100 transition-all overflow-hidden">
