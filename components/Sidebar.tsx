...
const Sidebar: React.FC<SidebarProps> = ({ currentView, userRole, setView, onLogout, isOpen, onClose, appConfig }) => {
  const menuItems = [
    ...
    { id: 'sondages', label: 'Sondages', icon: <React.Fragment><path d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" /><path d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" /></React.Fragment> },
  ...
  return (
    <>
      ...
      <div className={`
        fixed left-0 top-0 h-screen w-64 bg-white border-r border-slate-200 z-[100] 
